    ...
    <>
      <motion.div
        className={cn(
          ...
          className?.includes('bg-black') ? 'bg-black dark:bg-black' : 'bg-neutral-100 dark:bg-neutral-800',
          className
        )}
        animate={{
          ...
          {open && (
            <motion.div
              ...
              className={cn(
                ...
                className?.includes('bg-black') ? 'bg-black dark:bg-black' : 'bg-white dark:bg-neutral-900',
                className
              )}
            >
              <div
