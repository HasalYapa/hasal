...
const projects = [
  {
    ...
    longDescription: "A comprehensive e-commerce platform built with modern web technologies. Features include user authentication, product catalog, shopping cart, secure payments with Stripe, order management, and admin dashboard. The platform is fully responsive and optimized for performance.",
  ...
  },
  {
    ...
    longDescription: "A powerful task management application that enables teams to collaborate effectively. Features real-time updates using WebSockets, drag-and-drop task organization, team workspaces, file attachments, and detailed analytics. Built with modern React patterns and Node.js backend.",
